...
此外，如果发生了升降音，则该升降音的命名以正好凑满七个音名为准。例如，G 大调的音阶为 G-A-B-C-D-E-F♯-G，其中 F♯ 的命名以正好凑满七个音名为准，而不是命名为 G♭，尽管 F♯ 和 G♭ 是同一个音。
...
以 F4 作为主音，则 F 大调音阶为 F-G-A-B♭-C-D-E-F。F 大调有 B♭ 一个变化音，所以在五线谱中标记一个降号。这个降号标注在高音谱表中位于 B4 的位置。
...
以 B♭3 作为主音，则 B♭ 大调音阶为 B♭-C-D-E♭-F-G-A-B♭。B♭ 大调有 B♭ 和 E♭ 两个变化音，所以在五线谱中标记两个降号。这两个降号标注在高音谱表中位于 B4 和 E5 的位置。

{{< figure src="/learn/music-theory/images/大调调性-5.svg" caption="B♭ 大调音阶" >}}
...
以 E♭4 作为主音，则 E♭ 大调音阶为 E♭-F-G-A♭-B♭-C-D♭-E♭。E♭ 大调有 E♭、A♭ 和 B♭ 三个变化音，所以在五线谱中标记三个降号。这三个降号标注在高音谱表中位于 A4、B4 和 E5 的位置。

{{< figure src="/learn/music-theory/images/大调调性-7.svg" caption="E♭ 大调音阶" >}}
...
以 A♭4 作为主音，则 A♭ 大调音阶为 A♭-B♭-C-D♭-E♭-F-G-B♭。A♭ 大调有 A♭、B♭、D♭ 和 E♭ 四个变化音，所以在五线谱中标记四个降号。这四个降号标注在高音谱表中位于 A4、B4、D5 和 E5 的位置。

{{< figure src="/learn/music-theory/images/大调调性-9.svg" caption="A♭ 大调音阶" >}}
...
以 D♭4 作为主音，则 D♭ 大调音阶为 D♭-E♭-F-G♭-A♭-B♭-C-D♭。D♭ 大调有 D♭、E♭、G♭、A♭ 和 B♭ 五个变化音，所以在五线谱中标记五个降号。这五个降号标注在高音谱表中位于 G4、A4、B4、D5 和 E5 的位置。

{{< figure src="/learn/music-theory/images/大调调性-11.svg" caption="D♭ 大调音阶" >}}
...
以 G♭4 作为主音，则 G♭ 大调音阶为 G♭-A♭-B♭-C♭-D♭-E♭-F-G♭。G♭ 大调有 G♭、A♭、B♭、C♭、D♭ 和 E♭ 六个变化音，所以在五线谱中标记六个降号。这六个降号标注在高音谱表中位于 G4、A4、B4、C5、D5 和 E5 的位置。

{{< figure src="/learn/music-theory/images/大调调性-13.svg" caption="G♭ 大调音阶" >}}

{{< callout note >}}

F♯ 大调和 G♭ 大调是等音调，在音高上完全相同。
...
以 C♭4 作为主音，则 C♭ 大调音阶为 C♭-D♭-E♭-F♭-G♭-A♭-B♭-C♭。C♭ 大调相当于在 C 大调的基础上将所有的音都降低半音，所以在五线谱中标记七个降号。这七个降号标注在高音谱表中位于 F4、G4、A4、B5、C5、D5 和 E5 的位置。

{{< figure src="/learn/music-theory/images/大调调性-15.svg" caption="C♭ 大调音阶" >}}

{{< callout warning >}}

若无特殊需要，一般不会使用 C♯ 大调和 C♭ 大调来编写音乐。

实际上，C♯ 大调和 D♭ 大调是等音调，在音高上完全相同；同理，C♭ 大调和 B 大调是等音调，在音高上完全相同。
...
在调性五度圈中，外圈表示大调，内圈表示小调。具有相同主音的不同的调式位于同一方向上。为了统一命名方式和五线谱的表示，规定以前七个调（C、G、D、A、E、B、F♯）为主音的调性用升号 ♯ 标记五线谱的升降，后五个调（D♭、A♭、E♭、B♭、F）为主音调性用降号 ♭ 标记五线谱的升降。

从五度圈的 12 点出发（即 C 大调 / A 小调的位置），顺时针旋转表示主音升高纯五度，逆时针旋转表示降低纯五度。而至于各调性的主音，除 B 大调和 B♭ 大调外，其余各大调的主音均相对 C 大调升高。
