...
确定了主音的音阶序列被称为**调性**。确认了调性之后，才可以根据唱名（do-re-mi-fa-sol-la-si）确定音名（即在钢琴上的位置）。
...
{{< figure src="/learn/music-theory/images/大调调性-1.svg" >}}
...
{{< figure src="/learn/music-theory/images/大调调性-2.svg" >}}
...
{{< figure src="/learn/music-theory/images/大调调性-3.svg" >}}
...
{{< figure src="/learn/music-theory/images/大调调性-4.svg" >}}
...
{{< figure src="/learn/music-theory/images/大调调性-5.svg" >}}

## 小调调性

同理，以不同的音作为自然小调的主音，我们也可以得到十二种不同的小调调性。

| 主音  | 主音与 a 调的音程关系 | 调性命名 | la 所在音名 |
| :---: | :-------------------: | :------: | :---------: |
|   A   |        纯一度         |    Am    |     A4      |
| A#/Bb |        小七度         |   Bbm    |     Bb3     |
|   B   |        大七度         |    Bm    |     B3      |
...
2. 有些音以临时变音记号的形式出现。这种情况较难判断，因为有可能是[调式变音](../调式/#调式变音)。
