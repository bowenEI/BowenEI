...
此时导函数 $f'(x) \geqslant 0$，$f(x)$ 在区间 $(1, 2)$ 上单调递增。

那么 $f(x) > \lim_{x \to 1^{+}} f(x) = a$，也就是说 $f(x)$ 大于一个最小值为 $-2$ 的数，那显然 $f(x) > -2$ 恒成立，符合题意。
...
|   3   |   14   |      4       |     2      | 3 + 1 + 2 + <span style="color: #dd0000">4</span> + <span style="color: #00dd00">2</span> |
|   …   |   …    |      …       |     …      | …                                                                                         |
|   m   | 4m + 2 |    m + 1     |   m - 1    | 待求解                                                                                    |
